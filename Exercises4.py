...
#%%
""" 
We use a method of lists to sort numlist.  SORT() permanently reorders the list.
"""
print(numlist)
numlist.sort()
print(numlist)
#%%
""" 
Note that we already have a way of doing this sort. SORTED() doesn't permanently
change the list. 
"""
...
# lo que hace key=str.lower es pasar todo a lower case before sorting
print(Alphlist)
...
print("Start||{0}||End".format(s))  # lo mismo al anterior
print("Start||{0:25}||End".format(s))
print("Start||{0:>25}||End".format(s))
print("Start||{0:<25}||End".format(s))
print("Start||{0:^25}||End".format(s))
